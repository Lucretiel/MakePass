...
def gen_nums(rand_engine):
    '''
    Generate an infinite sequence of digits. each digit is a string
    '''
    local_str = str
...
def base_passwords(rand_engine, word_set, word_count, append_numeral, char=""):
    '''
    ...
    if char:
        gens.append(itertools.repeat(char))
...
def main(
    ...
    append_char: "Append the special character - to the password" =False,
    ...
    passwords = base_passwords(
        ...
        # TODO: use a full set of special characters, not just -
        char='-' if append_char else '',
    )
    ...
    if entropy_estimate or verbose:
        ...
        if verbose:
            ...
            if append_char:
                errfmt(
                    "The character - was appended. This added no entropy.")
